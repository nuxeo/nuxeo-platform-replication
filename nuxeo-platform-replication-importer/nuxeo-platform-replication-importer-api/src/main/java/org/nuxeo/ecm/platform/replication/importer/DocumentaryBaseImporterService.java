 ...
 * <p>Under “Documentary Base” the “Versions” folder contains the checked in 
 * versions. The versions are exported as the usual documents with single 
 * difference: without ACL and workflows. 
 * <p>Under “Documentary Base” the “Proxies” folder contains the proxies. They 
 * are exported as the usual documents with single difference: without workflows. 
...
public interface DocumentaryBaseImporterService {
    ...
    public void importDocuments(CoreSession session,
            ...
            boolean exportVersions, boolean exportProxies) throws ClientException;
}
